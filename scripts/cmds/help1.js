...
module.exports = {
  ...
  onStart: async function ({ message, args, event, threadsData, role }) {
    ...
    if (args.length === 0) {
      ...
      msg += ``;
      msg += `\n╭─────❃\n│🌟 | [ 𝐂𝐘𝐁𝐄𝐑 𝐋𝐈𝐒𝐀│https://www.facebook.com/profile.php?id=100080682514874\n╰────────────✦`attachment: await global.utils.getStreamFromURL("https://i.imgur.com/hDTLa1z.jpeg"); // its not decoy so change it if you want 
  ...
  ╰━━━━━━━❖`attachment: await global.utils.getStreamFromURL("https://i.imgur.com/hDTLa1z.jpeg");
